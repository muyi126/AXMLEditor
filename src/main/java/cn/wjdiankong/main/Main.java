...
public class Main {
    ...
    private final static String CMD_TXT = "[usage java -jar AXMLEditor.jar [-tag|-attr] [-i|-r|-m|-b] [标签名|标签唯一ID|属性名|属性值|需要被替换的值] [输入文件|输出文件]";
...
//        String inputfile = "xmltest/AndroidManifest.xml";
//        String outputfile = "xmltest/out.xml";
//        File inputFile = new File(inputfile);
//        File outputFile = new File(outputfile);
//        if (!inputFile.exists()) {
//            System.out.println("输入文件不存在...");
...
//        String oldPackageName = "com.vbooster.vbooster_private_space";
//        String attrName = "taskAffinity";
//        String attrValue = "com.vbooster.wxtest";
//        XmlEditor.BatchModifyAttr("activity", attrName, oldPackageName, attrValue);
//        XmlEditor.BatchModifyAttr("provider", "authorities", oldPackageName, attrValue);
//		XmlEditor.modifyPackageName("manifest", "package", oldPackageName, attrValue);
//		XmlEditor.modifyAttr("activity", "com.rpa.robot.stub.ActivityProxy$P0", attrName, attrValue);
    }
...
//                XmlEditor.test(tag, tagName, attr, value);
                ...
                XmlEditor.BatchModifyAttr(tag, attrName, oldValue, newValue);
